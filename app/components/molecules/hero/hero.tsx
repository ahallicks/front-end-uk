...
const rte2: RichTextProps['renderers'] = {
	p: ({ children }) => (
		<p className="relative rounded-full px-3 py-1 text-sm/6 text-gray-600 dark:text-white ring-1 ring-gray-900/10 hover:ring-gray-900/20 dark:ring-white/10 dark:hover:ring-white/20">
			{children}
		</p>
	),
	a: ({ children, href }) => (
...
export const Hero: React.FC<IHero> = ({ keyline, title, content, links }) => {
	return (
