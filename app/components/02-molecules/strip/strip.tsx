...
export const Strip: React.FC<IStrip> = ({
	...
	return (
		<div className="relative isolate z-1 flex shrink-0 items-center gap-x-6 overflow-hidden rounded-md bg-gray-50 px-6 py-2.5 sm:px-3.5 sm:before:flex-1 dark:bg-gray-800/50">
			<div
				aria-hidden="true"
