...
import { CodePen } from '~/components/01-atoms/codepen/codepen.tsx';
import { PageDate } from '~/components/01-atoms/page-date/page-date.tsx';
import { YouTube } from '~/components/01-atoms/youtube/youtube.tsx';
...
SyntaxHighlighter.registerLanguage('powershell', shell);
...
> = ({
	...
	<>
		...
		<PageDate published={published} created={created} updated={updated} />
	</>
);
...
> = ({
	...
	<section className="main-content segment relative isolate overflow-hidden bg-white px-6 py-24 contain-paint sm:py-32 lg:overflow-visible lg:px-0 dark:bg-gray-900">
